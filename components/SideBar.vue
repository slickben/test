<template>
    <div :class="{ hidden: !toggleNav }" class="w-64 absolute sm:relative bg-gray-500 shadow md:h-full pb-12">
            <div class="px-8">
                ...
                <h3 class="text-base capitalize font-bold mt-12">profile manager</h3>
                <ul class="pt-3">
